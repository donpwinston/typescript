...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id;
    if (id) return axios_1["default"].put(this.url + "/" + id, data);else return axios_1["default"].post(this.url, data);
  };
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(url));
  };

  User.buildUserColection = function () {
